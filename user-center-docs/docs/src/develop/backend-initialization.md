...
![image-20240128193704477](https://notebook.mlinyun.com/user-center/image-20240128193704477.png)

但是我们不用上面的方法创建项目，而是使用开发工具 IntelliJ IDEA 来快速的创建一个 Spring Boot 骨架工程。其实和上面的在线生成很相似。

![image-20240128194351289](https://notebook.mlinyun.com/user-center/image-20240128194351289.png)
...
![image-20240128194917415](https://notebook.mlinyun.com/user-center/image-20240128194917415.png)

然后我们点击创建按钮，它就会自动帮助我们生成代码：

![image-20240128195618563](https://notebook.mlinyun.com/user-center/image-20240128195618563.png)
...
![image-20240128203814237](https://notebook.mlinyun.com/user-center/image-20240128203814237.png)
...
![image-20240128204237334](https://notebook.mlinyun.com/user-center/image-20240128204237334.png)
...
![image-20240128204609877](https://notebook.mlinyun.com/user-center/image-20240128204609877.png)
...
![image-20240128200611711](https://notebook.mlinyun.com/user-center/image-20240128200611711.png)

注意：上面的命令中的 `mysql80` 是 MySQL 服务的名字，如果你忘记了，可以通过下面的方式找到：打开任务管理器，点击服务一项，然后寻找带有
`mysql` 相关的单词的服务，这个大概率就是 MySQL 服务名了。

![image-20240128201516048](https://notebook.mlinyun.com/user-center/image-20240128201516048.png)

MySQL 服务启动后，我们就可以在 IDEA 中进行连接了，我们只需要填写用户名和密码就行，然后点击测试连接，成功之后在点击确定就可以了。

![image-20240128202018451](https://notebook.mlinyun.com/user-center/image-20240128202018451.png)
...
![image-20240128210704134](https://notebook.mlinyun.com/user-center/image-20240128210704134.png)
...
![image-20240129005059574](https://notebook.mlinyun.com/user-center/image-20240129005059574.png)
...
![image-20240129011020703](https://notebook.mlinyun.com/user-center/image-20240129011020703.png)
...
![image-20240129010616764](https://notebook.mlinyun.com/user-center/image-20240129010616764-1706461579981-1.png)
...
![image-20240129012701151](https://notebook.mlinyun.com/user-center/image-20240129012701151.png)
...
![image-20240129015002223](https://notebook.mlinyun.com/user-center/image-20240129015002223.png)
...
![image-20240129021242031](https://notebook.mlinyun.com/user-center/image-20240129021242031.png)
...
![image-20240129015240904](https://notebook.mlinyun.com/user-center/image-20240129015240904.png)
...
![image-20240129015447292](https://notebook.mlinyun.com/user-center/image-20240129015447292.png)
...
![image-20240129022415737](https://notebook.mlinyun.com/user-center/image-20240129022415737.png)
...
![image-20240129022811599](https://notebook.mlinyun.com/user-center/image-20240129022811599.png)
...
![image-20240129023819885](https://notebook.mlinyun.com/user-center/image-20240129023819885.png)

UserMapper 中的 `selectList()` 方法的参数为 MP 内置的条件封装器 `Wrapper`，所以不填写就是无任何条件。

然后我们点击右侧的测试按钮，在控制台中会输出：

![image-20240129024134787](https://notebook.mlinyun.com/user-center/image-20240129024134787.png)
